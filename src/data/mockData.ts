...
export const mockProducts: Product[] = [
  // Electronics
  { id: '1', name: 'Samsung Galaxy S24 Ultra', category: 'electronics', price_krw: 1800000, weight: 0.5, image_url: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400', description: 'Smartphone haut de gamme avec caméra 200MP', in_stock: true, created_at: '2024-01-01', updated_at: '2024-01-01' },
  ...
  { id: '3', name: 'MacBook Pro M3', category: 'electronics', price_krw: 3200000, weight: 2.0, image_url: 'https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=400', description: 'Ordinateur portable professionnel', in_stock: true, created_at: '2024-01-01', updated_at: '2024-01-01' },
  ...
  // Vehicles
  { id: '11', name: 'Hyundai Tucson 2024', category: 'vehicles', price_krw: 35000000, weight: 1500, image_url: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=400', description: 'SUV hybride 7 places', in_stock: true, created_at: '2024-01-01', updated_at: '2024-01-01' },
  ...
  // Appliances
  { id: '21', name: 'LG Réfrigérateur Inox', category: 'appliances', price_krw: 1500000, weight: 120, image_url: 'https://images.unsplash.com/photo-1571175443880-49e1d25b2bc5?w=400', description: 'Réfrigérateur double porte 500L', in_stock: true, created_at: '2024-01-01', updated_at: '2024-01-01' },
