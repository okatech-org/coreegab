          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center justify-center md:justify-start gap-2">
                ...
                <span className="text-background/80">+241 XX XX XX XX</span>
              </div>
              <div className="flex items-center justify-center md:justify-start gap-2">
                <Mail className="w-4 h-4 text-secondary" />
                <span className="text-background/80">contact@coregab.ga</span>
              </div>
              <div className="flex items-center justify-center md:justify-start gap-2">
                <MapPin className="w-4 h-4 text-secondary" />
                <span className="text-background/80">Libreville, Gabon</span>
              </div>
            </div>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold mb-4 text-background">Nos Services</h4>
