  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        />
        {/* Overlay adaptatif pour améliorer la lisibilité du texte */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/50 to-black/40 hero-overlay"></div>
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4 sm:p-6 md:p-8 lg:p-12">
        <div className="w-full max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl text-center mx-auto">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-6xl font-bold hero-title mb-4 sm:mb-6 md:mb-8 lg:mb-10 leading-tight drop-shadow-2xl px-2">
            Importez depuis la{' '}
            <span className="hero-korea-gradient block sm:inline">
              Corée du Sud
            </span>
          </h1>

          <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl hero-description max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-4xl mx-auto mb-6 sm:mb-8 md:mb-10 lg:mb-12 leading-relaxed drop-shadow-lg px-2 font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center items-center w-full max-w-md sm:max-w-lg md:max-w-2xl mx-auto px-2">
            {user ? (
              ...
              <>
                <Button 
                  size="default" 
                  className="text-sm sm:text-base md:text-lg lg:text-xl px-4 sm:px-6 md:px-8 lg:px-10 py-3 sm:py-4 md:py-5 lg:py-6 w-full sm:w-auto min-w-[180px] sm:min-w-[200px] md:min-w-[220px] lg:min-w-[250px] hero-primary-button font-semibold"
                  onClick={() => {
                ...
                <Button 
                  size="default" 
                  variant="outline" 
                  className="text-sm sm:text-base md:text-lg lg:text-xl px-4 sm:px-6 md:px-8 lg:px-10 py-3 sm:py-4 md:py-5 lg:py-6 w-full sm:w-auto min-w-[180px] sm:min-w-[200px] md:min-w-[220px] lg:min-w-[250px] hero-secondary-button font-semibold"
